...
const BRANDS: Record<string, {
  ...
  mudateapanama: {
    ...
    ctaText: "Recibe la guía de relocación gratis →",
  ...
  dolarizate: {
    ...
    ctaText: "Recibe el comparativo de cuentas gratis →",
    ctaUrl: "#email-capture",
    icon: "💵",
    ...
    stats: [
      ...
      { label: "Costo de apertura", value: "$0" },
    ],
  },
  remesas: {
    name: "Remesas.co",
    ...
    ctaText: "Recibe el comparativo de remesas gratis →",
    ctaUrl: "#email-capture",
    icon: "💸",
